...
import { Calendar, Trophy, Sparkles, LogOut, BarChart3, ClipboardList, KeyRound, Sun, Moon } from 'lucide-react-native';
      ...
      <SafeAreaView edges={['top']} style={styles.safeArea}>
        <ScrollView style={styles.scroll} contentContainerStyle={styles.content}>
          <View style={styles.profileSection}>
            ...
            <Text style={[styles.role, { color: colors.muted }]}>{getRoleLabel(user?.role ?? 'teamlead')}</Text>
          </View>
