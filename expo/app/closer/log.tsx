      ...
      <SafeAreaView edges={['top']} style={styles.safeArea}>
        <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={[styles.formCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
            <Text style={[styles.formLabel, { color: colors.text }]}>📋 Daily Order Log</Text>
            ...
            <View style={styles.fieldsRow}>
              <NumField label="UPSELLS (₦600 IF ≥50%)" value={upsells} onChange={setUpsells} colors={colors} />
              <NumField label="REPEAT CUSTOMERS (₦300)" value={repeats} onChange={setRepeats} colors={colors} />
            ...
            <View style={[styles.commPreview, { backgroundColor: colors.background }]}>
              ...
              <View style={styles.commRow}>
                ...
                <View style={[styles.tierBadge, { backgroundColor: getTierColor(commission.tier, colors) + '30' }]}>
                  <Text style={[styles.tierText, { color: getTierColor(commission.tier, colors) }]}>
                ...
                <View key={log.id} style={[styles.pastCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
                  <View style={styles.pastRow}>
                    ...
                    <View style={[styles.rateBadge, { backgroundColor: getRateColor(log.commission.rate, colors) + '20' }]}>
                      <Text style={[styles.rateText, { color: getRateColor(log.commission.rate, colors) }]}>
                        {log.commission.rate}%
                      </Text>
                    </View>
                    ...
                    <View style={[styles.statusBadge, { backgroundColor: getStatusColor(log.status, colors) + '20' }]}>
                      <Text style={[styles.statusText, { color: getStatusColor(log.status, colors) }]}>
                        {log.status}
                      </Text>
                    </View>
                  </View>
...
const styles = StyleSheet.create({
  ...
  formLabel: { fontSize: 15, fontWeight: '700' as const, marginBottom: 16 },
